    ...
    public partial class frmSearchSale : Form
    {
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string qry = @"SELECT SaleId,SaleDate,SaleMan,PartyCode,
            PartyName,TotalAmount FROM SaleMaster where SaleId like '%" + txtSearch.Text + "%' order by SaleId desc";
