...
{
    public partial class frmSearchPurchaseReturn : Form
    {
        string ID;
        public string Id
        {
        ...
        public frmSearchPurchaseReturn()
        {
            InitializeComponent();
            Initlize();
        }
        public void Initlize()
        {
            ...
            dt = CRUD.GetPurchaseReturnData(Co);
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                FROM PurchaseReturnMaster where PurchaseReturnId like '%" + txtSearch.Text + "%' order by PurchaseReturnId desc";
