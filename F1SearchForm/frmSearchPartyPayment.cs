...
{
    public partial class frmSearchPartyPayment : Form
    {
        string ID;
        string Article;
        public string Id
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                FROM Voucher where VoucherID like '%"+txtSearch.Text+"%' and IsDeleted = 0 order by VoucherID desc";
