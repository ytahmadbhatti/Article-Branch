...
{
    public partial class frmSearchSaleReturn : Form
    {
        string ID;
        public string Id
        {
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ,PartyName,TotalAmount FROM SaleReturnMaster where SaleReturnId like '%" + txtSearch.Text + "%' order by SaleReturnId desc";
